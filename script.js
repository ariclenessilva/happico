...
const animatedElements = document.querySelectorAll('.service-card, .project-card, .stat-item, .visual-card');
...
projectCards.forEach(card => {
    ...
    if (btn) {
        btn.addEventListener('click', () => {
            ...
            showNotification(`Projeto "${title}" - Em breve mais detalhes!`, 'info');
        });
    }
});
